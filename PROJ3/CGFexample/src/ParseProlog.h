...
bool parseAnswerJogada(std::string answer, vector<vector<PieceData> > &newBoard, string &gameOver, vector<PieceData> &pecasAdicionadas, vector<PieceData> &pecasRemovidas, vector<PieceData> &jogadasComputador);
